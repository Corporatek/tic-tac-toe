...
// Game moves start below
// link: https://git.generalassemb.ly/ga-wdi-boston/game-project-api/blob/master/docs/game.md

// Get request instructions => https://www.youtube.com/watch?v=fEYx8dQr_cQ
// Post request instructions => https://www.youtube.com/watch?annotation_id=annotation_1270129147&feature=iv&src_vid=fEYx8dQr_cQ&v=5nL7X1UMWsc

// var game = store.game

// var gameboard = {
//   cells: store.game.value,
...
var newGame = function newGame() {
  ...
  //success: console.log('successfully created a new game'),
  // success: console.log(gameboard)      
...
var updateGame = function updateGame(index, value, over) {
  return $.ajax({
    ...
    success: console.log('successfully updated game')
  });
};
...
$(document).ready(function () {
  ...
  $(square1).click(function () {
    ...
    var value = document.getElementById('square1').innerText;
    var index = 0;

    api.updateGame(index, value, false); // <--- replace false

    // console.log(index, value)

    // append the index and move as key value pair into the game object
  });

  $(square2).click(function () {
    playerMove(this);
    var value = document.getElementById('square2').innerText;
    var index = 1;
    api.updateGame(index, value, store.game.over);
  });

  $(square3).click(function () {
    playerMove(this);
    var value = document.getElementById('square3').innerText;
    var index = 2;
    api.updateGame(index, value, store.game.over);
  });
  ...
  $(square4).click(function () {
    playerMove(this);
    var value = document.getElementById('square4').innerText;
    var index = 3;
    api.updateGame(index, value, store.game.over);
  });
  ...
  $(square5).click(function () {
    playerMove(this);
    var value = document.getElementById('square5').innerText;
    var index = 4;
    api.updateGame(index, value, store.game.over);
  });
  $(square6).click(function () {
    playerMove(this);
    var value = document.getElementById('square6').innerText;
    var index = 5;
    api.updateGame(index, value, store.game.over);
  });
  $(square7).click(function () {
    playerMove(this);
    var value = document.getElementById('square7').innerText;
    var index = 6;
    api.updateGame(index, value, store.game.over);
  });
  $(square8).click(function () {
    playerMove(this);
    var value = document.getElementById('square8').innerText;
    var index = 7;
    api.updateGame(index, value, store.game.over);
  });
  $(square9).click(function () {
    playerMove(this);
    var value = document.getElementById('square9').innerText;
    var index = 8;
    api.updateGame(index, value, store.game.over);
  });
  ...
  function checkForWinner(move) {
    var result = false;
    if (checkRow(1, 2, 3, move) || checkRow(4, 5, 6, move) || checkRow(7, 8, 9, move) || checkRow(1, 4, 7, move) || checkRow(2, 5, 8, move) || checkRow(3, 6, 8, move) || checkRow(1, 5, 9, move) || checkRow(3, 5, 7, move)) {
      result = true;
    }
    return result;
  }

  // write a tie function
  // If 8/9 elements with the id "box" is populated and check winner function returns false
  // Alert users its a tie game
...
var updateMove = function updateMove(event) {
  event.preventDefault();
  console.log('update ran!');

  // const data = store.game
  // api.updateGame(data.index, data.value, data.over)
  // .then(ui.userMoveSuccess)
  // .catch(ui.userMoveFailed)
};
...
var userMoveSuccess = function userMoveSuccess() {
  console.log('succussfully logged move');
};

var userMoveFail = function userMoveFail() {
...
// Below is the change password and signout feature
...
module.exports = {
  ...
  userMoveSuccess: userMoveSuccess,
  userMoveFail: userMoveFail
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = __webpack_require__.p + "581c9084af5bc4d49226c70727c0ea7b.png";
